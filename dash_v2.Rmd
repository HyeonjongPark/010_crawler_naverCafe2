...
selectInput("i","Start Date",choices = unique(flag_tid$date), selected = min(flag_tid$date))
selectInput("j","End Date",choices = unique(flag_tid$date), selected = max(flag_tid$date))
...
pp_tid4 = cafe_like_func(cafeWritten, start_day_g(), end_day_h())
